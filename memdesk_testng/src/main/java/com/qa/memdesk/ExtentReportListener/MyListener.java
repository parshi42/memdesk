package com.qa.memdesk.ExtentReportListener;
...
public class MyListener extends TestBase implements ITestListener {
 ...
 public void onTestFailure(ITestResult result) {
  ...
  try {
	  ...
	  FileUtils.copyFile(src, new File("D:\\Screenshots\\" + result.getMethod().getMethodName() + ".png"));
	  String file = test.addScreenCapture("D:\\Screenshots\\" + result.getMethod().getMethodName() + ".png");   	  
